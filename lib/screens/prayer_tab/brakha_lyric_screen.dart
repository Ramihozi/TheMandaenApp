...
class BrakhaLyricScreen extends StatefulWidget {
  @override
  _BrakhaLyricScreenState createState() => _BrakhaLyricScreenState();
}

class _BrakhaLyricScreenState extends State<BrakhaLyricScreen> {
  ...
  Future<void> _loadLyrics() async {
    try {
      String data = await DefaultAssetBundle.of(context).loadString('assets/prayers/brakha.json');
