...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadLanguagePreference() async {
    ...
    if (savedIsEnglish != null) {
      ...
      print('Language loaded: ${_controller.isEnglish.value ? 'English' : 'Arabic'}');
    }
  }
  ...
  Future<void> _toggleLanguage() async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('isEnglish', _controller.isEnglish.value); // Save language preference
    print('Language toggled: ${_controller.isEnglish.value ? 'English' : 'Arabic'}');
  }
  ...
  Widget build(BuildContext context) {
    final TextStyle englishTextStyle = TextStyle(fontSize: 15.0); // Default font size for English
    final TextStyle arabicTextStyle = TextStyle(fontSize: 19.0); // Larger font size for Arabic
              ...
              child: Column(
                ...
                children: [
                    ...
                    onPressed: () async {
                      bool? confirmDelete = await showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          title: Text(_getText('Confirm Deletion', 'تأكيد الحذف')),
                          content: Text(
                            _getText(
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      bool? confirmChangePassword = await showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
                          title: Text(_getText('Change Password', 'تغيير كلمة المرور')),
                          content: Column(
                            ...
                            children: [
                              TextField(
                                ...
                                decoration: InputDecoration(
                                    labelText: _getText('Current Password', 'كلمة المرور الحالية')),
                              ),
                              TextField(
                                controller: _controller.newPasswordController,
                                obscureText: true,
                                decoration: InputDecoration(
                                    labelText: _getText('New Password', 'كلمة المرور الجديدة')),
                              ),
                            ],
                          ),
                          actions: [
                    ...
                    child: Text(_getText('Change Password', 'تغيير كلمة المرور'),
                      style: _getTextStyle(), // Apply custom text style here
                    ),
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.amber,
                    ...
                    return _controller.blockedUsers.isNotEmpty
                      ...
                      children: [
                        Text(
                          ...
                          style: Theme.of(context).textTheme.titleMedium, // Existing style
                        ),
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () async {
                                bool? confirmUnblock = await showDialog(
                                  context: context,
                                  builder: (context) => AlertDialog(
                                    title: Text(_getText('Confirm Unblock', 'تأكيد إلغاء الحظر')),
                                    content: Text(
                                      _getText(
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () => Navigator.of(context).pop(true),
                                        child: Text(_getText('Unblock', 'إلغاء الحظر')),
                                      ),
                                    ],
                                  ),
                                );
                        ...
                        : Text(
                      _getText('No blocked users.', 'لا يوجد مستخدمين محظورين.'),
                  ...
                  Align(
                    ...
                    child: Obx(
                          () => ElevatedButton(
                        onPressed: _toggleLanguage, // Use the method to toggle state
                        style: ElevatedButton.styleFrom(
  ...
  await showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      content: TextField(
        ...
        decoration: InputDecoration(labelText: _getText('Password', 'كلمة المرور')),
      ),
      actions: [
        TextButton(
